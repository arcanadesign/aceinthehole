...
?>
    ...
    <div id="hero">
        <a href="#"></a><img src="images/slide3.jpg" alt="image placeholder"></div>
        
    <!-- Weather Widget Script from weatherwidget.io-->
    ...
    !function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
        ...
        <main>
            ...
            <section>
                ...
                <h3>September 15th and 16th, 2018</h3>
            ...
            <section id="eventinfo" class="section group">
                ...
                <div class="section group">
                    ...
                    <div class="col span_1_of_3">
                        <img src="images/featured1.jpg" alt="image placeholder">
                    </div>
                ...
                <div id="button"><a href="registration.php" class="buttonstyle" style="top: 232px; left: 186px;">Register</a></div>
                
            </section>
            
            <section id="eventdesc" class="section group">
    ...
    <section id="feedsection" class="section group">
        
                <div class="col span_1_of_3">
                    <a class="weatherwidget-io" href="https://forecast7.com/en/45d52n122d68/portland/?unit=us" data-label_1="PORTLAND" data-label_2="WEATHER" data-font="Roboto" data-theme="pure" >PORTLAND WEATHER</a>
                </div>
        
                <div class="col span_1_of_3">
                    <a class="twitter-timeline" width="340" height="500" href="https://twitter.com/pcccas222?ref_src=twsrc%5Etfw" data-tweet-limit="3">Tweets by pcccas222</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script> 
                </div>

                <div class="col span_1_of_3">
                    <iframe src="https://www.facebook.com/plugins/page.php?href=https://www.facebook.com/cas222cascade/%2Ffacebook&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" class="fbfeed" width="340" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
                </div>
